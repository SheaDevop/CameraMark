    ...
    <footer className='pt-16 bg-primary'>
      <div className='container mx-auto'>
        ...
        <div className='flex gap-x-6 max-w-max mx-auto text-lg mb-16'>
          <a href='https://github.com/SheaDevop' className='hover:text-white transition-all'>
            <FaGithub/>
          </a>
          <a href='https://www.linkedin.com/in/ignacio-dieguez-5aa9a923b/' className='hover:text-white transition-all'>
            <FaLinkedin/>
          </a>
        </div>
      </div>
      <div className='py-10 border-t border-t-white/10'>
        <div className='container mx-auto'>
          <div className='text-center text-sm text-white/60'>Copyright &copy; CameraMark 2023. All rights reserved.</div>
        </div>
      </div>
    </footer>
  );
